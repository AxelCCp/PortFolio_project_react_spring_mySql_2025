...
insert into user_system (name, lastname, position, area, email, password) values ('Admin', 'consect', 'Master', 'Europe', 'vitae@finibus.com', 123);
insert into user_system (name, lastname, position, area, email, password) values ('Giru', 'adipiscing', 'Java developer', 'Latam', 'quis@ligula.com', 123);
insert into user_system (name, lastname, position, area, email, password) values ('Bils', 'sapien', 'Python developer', 'Asia', 'orci@neque.jp', 123);
insert into user_system (name, lastname, position, area, email, password) values ('ZhenLong', 'Nullam', 'Database manager', 'Asia', 'non@ipsum.jp', 123);
insert into user_system (name, lastname, position, area, email, password) values ('Boo', 'condimentum', 'Sales manager', 'USA', 'gravida@lacus.com', 123);
